...
export const editDevice = async (
    ...
    try {
        ...
        const response =
            await deviceService.editDevice(
                deviceID,
                updateData,
            );
...
export const latestdevicedata = async (
    ...
    try {
        const response =
            await deviceService.latestdevicedata(
                req.body,
            );
...
export const latestdevicedataBydate = async (
    ...
    try {
        const response =
            await deviceService.latestdevicedataBydate(
                req.body,
            );
...
export const getDeviceListBySiteIds =
    async (
        ...
        try {
            const response =
                await deviceService.getDeviceListBySiteIds(
                    req.body.siteIds,
                    req.user,
                );
...
export const getdeviceListByuserId =
    async (
        ...
        try {
            const response =
                await deviceService.getdeviceListByuserId(
                    req.body,
                    req.user,
                );
...
export const getDeviceDataById =
    async (
        ...
        try {
            ...
            const response =
                await deviceService.getDeviceDataById(
                    deviceId,
                );
...
export const checkDeviceUid = async (
    ...
    try {
        const response =
            await deviceService.checkDeviceUid(
                req.body.nodeUid,
            );
...
export const downloadcsv = async (
    ...
    try {
        const filePath =
            await deviceService.downloadcsv();
...
export const getDeviceByuserId =
    async (
        ...
        try {
            ...
            const response =
                await deviceService.getDeviceByuserId(
                    userId,
                );
...
export const deviceReboot = async (
    ...
    try {
        const response =
            await deviceService.deviceReboot();
...
export const deviceShutdown =
    async (
        ...
        try {
            const response =
                await deviceService.deviceShutdown();
